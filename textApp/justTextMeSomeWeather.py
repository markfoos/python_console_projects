# python 3
# texting program wiht Twilio
# created by Mark Foos
import json, requests, sys, time, math


accountSID = 'enter your accountSID here'
authToken = 'enter your authToken here'
inputNumber = str(input("Enter your number(w/ area code): "))
myNumber = str("+1" + (inputNumber))

twilioNumber = 'enter your twilioNumber here'
...
api_key = "enter you openweatherman api key here"
...
#    print("Coming from the " + str(degToCompass(wind_dir)))
    print("Sending Text Message to: " + myNumber)
    textmyself("Gathering weather data for: " + str(location_name) + "\n" +
    "The current temperature is " + str(Fahr(current_temperature)) + " degrees." + "\n" +
    "The high for today is " + str(Fahr(temp_high)) + " degrees." + "\n" +
    "The low for today is " + str(Fahr(temp_low)) + " degrees." + "\n" +
    "The weather can be described as: " + str(weather_description) + "\n" +
    "With a wind speed of " + str(mps2mph(wind_speed)) + " MPH" + "\n")
#    "Coming from the " + str(degToCompass(wind_dir)))
